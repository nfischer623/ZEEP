...
float [] NewtonsMethod(float a, float b){
    ...
    float denominator = 9*(a*a*a*a + 2*a*a*b*b + b*b*b*b);
    a = a - ((3*(a*a*a*a*a + 5*a*a*a*b*b - 3*a*a*a*b*b*b*b + a*a + a*b*b*b*b - b*b))/denominator);
    b = b - ((3*(a*a*a*a*b + 2*a*a*b*b*b + b*b*b*b*b - 2*a*b))/denominator);
    float [] new_num = {a, b};
    return new_num;
}
